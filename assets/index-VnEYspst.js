...
`;document.querySelector("#app").innerHTML=oe;document.addEventListener("DOMContentLoaded",()=>{const a=new J,e=new _(a),n=new K,t=new se(n),s=async(c,h)=>{document.dispatchEvent(new Event("visualization-start")),await t.visualize(h,c.pausePoint.bind(c))};let i=new L(()=>s(i,a.getSelectAlgorithm().value));const r=a.getBtnRun().innerHTML,o=a.getBtnPause().innerHTML,l=n.getCountVisitedNodes().innerHTML,u=n.getCountPathNodes().innerHTML,m=n.getTotalPathCost().innerHTML,C=n.getExecutionTime().innerHTML,d=a.getBtnRun(),y=a.getBtnPause(),E=a.getBtnResetGrid(),S=a.getBtnClearPath(),k=a.getBtnClearWalls(),T=a.getBtnGenerateMaze(),R=n.getBoardElement(),v=a.getSelectAlgorithm(),z=n.getWeightElement(),V=n.getModeInputs(),F=n.getCountVisitedNodes(),G=n.getCountPathNodes(),O=n.getTotalPathCost(),j=n.getExecutionTime();t.handleDrawModeChange(),t.handleDrawBoard(),t.handleCounts(),e.hanldeSelectWeightChange(),e.handleSelectAlgorithmChange(),e.handleSelectSpeedChange(),e.handleButtonRunClick(()=>{i.start()}),e.handleButtonPauseClick(()=>{i.getIsPaused()?(i.resume(),v.disabled=!0,E.disabled=!0,y.querySelector("svg path").setAttribute("d",P.PAUSE)):(i.pause(),v.disabled=!1,E.disabled=!1,y.querySelector("svg path").setAttribute("d",P.PLAY))}),e.handleButtonResetGridClick(()=>{i.reset(),t.handleResetGrid(),document.dispatchEvent(new Event("visualization-end"))}),e.handleButtonClearPathClick(()=>{t.handleClearPath()}),e.handleButtonClearWallsClick(()=>{t.handleClearWalls()}),e.handleButtonGenerateMazeClick(()=>{t.handleClearPath(),t.handleClearWalls(),t.generateMaze()}),document.addEventListener("weight-change",c=>{const h=c.detail.weight;z.dataset.weight=h.toString()}),document.addEventListener("algorithm-change",c=>{const h=c.detail.algorithm;i=new L(()=>s(i,h));const f=document.querySelector('label[for="mode-weight"]');if(h==p.DIJKSTRA||h==p.ASTAR)f.style.display="block";else{f.style.display="none";const I=V.item(0);I.checked=!0,I.dispatchEvent(new Event("change"))}document.dispatchEvent(new Event("visualization-end"))}),document.addEventListener("speed-change",c=>{const h=c.detail.speed;t.setSpeed(h)}),document.addEventListener("board-update",c=>{const h=c.detail.startNode,f=c.detail.endNode;h&&f?(a.getBtnRun().disabled=!1,a.getBtnGenerateMaze().disabled=!1):(a.getBtnRun().disabled=!0,a.getBtnGenerateMaze().disabled=!0)}),document.addEventListener("visualization-start",()=>{R.style.pointerEvents="none",d.textContent="Running...",d.disabled=!0,y.disabled=!1,E.disabled=!0,S.disabled=!0,k.disabled=!0,T.disabled=!0,v.disabled=!0,F.innerHTML=l,G.innerHTML=u,O.innerHTML=m,j.innerHTML=C,(v.value===p.DFS||v.value===p.BFS)&&t.handleClearWeights(),t.handleClearPath()}),document.addEventListener("visualization-end",()=>{document.dispatchEvent(new CustomEvent("board-update",{detail:{startNode:t.getStartNode(),endNode:t.getEndNode()}})),y.disabled=!0,d.innerHTML=r,y.innerHTML=o,R.style.pointerEvents="auto",v.disabled=!1,E.disabled=!1,S.disabled=!1,k.disabled=!1,T.disabled=!1});const U=c=>{const h=new H(c.row,c.col);return h.setStart(c.isStart),h.setWall(c.isWall),h.setWeight(c.weight),h.setEnd(c.isEnd),h.setVisited(c.isVisited),h.setPath(c.isPath),h.setDistance(c.distance??1/0),h.setHeuristic(c.heuristic),h};e.handleButtonExportFile(()=>D({...t.getModel(),startNode:t.getStartNode(),endNode:t.getEndNode()})),e.handleButtonImportFile(c=>{const h=D(c,!1),f=new M(h.numRows,h.numCols);f.setNodes(h.nodes.map(q=>q.map(U)));const I=f.getNode(h.startNode.row,h.startNode.col),$=f.getNode(h.endNode.row,h.endNode.col);t.handleReRenderBoard(f,I,$)})});
